...
const services = [
    {
        ...
        link: '/services/pre-project-activities'
    },
    {
    ...
    },
    {
        ...
        link: '/services/engineering-services-detail'
    },
    {
    ...
    },
    {
        ...
        link: '/services/maintenance-retrofits'
    }
];
            ...
            <div className="container">
                ...
                >
                    {services.map((service, index) => (
                        <Link to={service.link} key={service.title} style={{ textDecoration: 'none', color: 'inherit' }}>
                            <motion.div
